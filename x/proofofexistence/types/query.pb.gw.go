...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 2, 2}, []string{"empowerchain", "proofofexistence", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Proof_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"empowerchain", "proofofexistence", "proof", "hash"}, "", runtime.AssumeColonVerbOpt(false)))
)
