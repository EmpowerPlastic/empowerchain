...
var (
	...
	ErrNotEnoughActiveCredits   = errors.Register(ModuleName, 1109, "not enough active credits")
	ErrIssuerNotFound           = errors.Register(ModuleName, 1110, "issuer not found")
	ErrNotIssuer                = errors.Register(ModuleName, 1111, "address is not an issuer")
)
