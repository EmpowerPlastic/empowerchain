...
type GenesisState struct {
	...
	CreditCollections []*IDCreditCollection `protobuf:"bytes,4,rep,name=credit_collections,json=creditCollections,proto3" json:"credit_collections,omitempty"`
	CreditBalances    []*IDCreditBalance    `protobuf:"bytes,5,rep,name=credit_balances,json=creditBalances,proto3" json:"credit_balances,omitempty"`
...
func (m *GenesisState) GetCreditCollections() []*IDCreditCollection {
	if m != nil {
...
func (m *GenesisState) GetCreditBalances() []*IDCreditBalance {
	if m != nil {
...
var fileDescriptor_3d9a84508647bd6f = []byte{
	...
	,
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.CreditCollections = append(m.CreditCollections, &IDCreditCollection{})
		...
		case 5:
			...
			m.CreditBalances = append(m.CreditBalances, &IDCreditBalance{})
