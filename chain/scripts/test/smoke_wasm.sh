...
sleep 5
INSTANTIATE_TX_HASH=$($BINARY tx wasm instantiate $CODE_ID '{"admin": "empower18hl5c9xn5dze2g50uaw0l2mr02ew57zkk9vga7", "fee_percentage": "0", "shares": []}' --label marketplace --admin empower18hl5c9xn5dze2g50uaw0l2mr02ew57zkk9vga7 --from alice --home $CHAIN_DIR --node tcp://:$RPC_PORT --keyring-backend test --gas auto --gas-prices 0.025umpwr --gas-adjustment 1.75 --chain-id $CHAIN_ID --yes --output json | jq -r ".txhash")
sleep 5
