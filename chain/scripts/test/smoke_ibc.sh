...
$BINARY tx ibc-transfer transfer transfer channel-0 cosmos1j0hkmu8rklcewz4g0wclxlzf4tzhlx00fe2uew 1337mpwr --home $CHAIN_DIR --node tcp://:$RPC_PORT --keyring-backend test --from alice --gas auto --gas-adjustment 1.4 --gas-prices 0.025umpwr --chain-id $CHAIN_ID --yes
sleep 10
