...
func (s *TestSuite) SetupSuite() {
	...
	AddGenesisTestData(&e2eGenesisState, s.Config.BondDenom, s.Config.StakingTokens, s.CreditClassCreationFee)
...
func AddGenesisTestData(genesisState *GenesisState, bondDenom string, tokens math.Int, creditClassCreationFee sdk.Coin) {
	...
	genesisState.BankGenesis.Balances = append(genesisState.BankGenesis.Balances, banktypes.Balance{Address: IssuerAddress, Coins: balances})
	genesisState.BankGenesis.Balances = append(genesisState.BankGenesis.Balances, banktypes.Balance{Address: IssuerCreatorAddress, Coins: balances})
	genesisState.BankGenesis.Balances = append(genesisState.BankGenesis.Balances, banktypes.Balance{Address: ApplicantAddress, Coins: balances})
	genesisState.BankGenesis.Balances = append(genesisState.BankGenesis.Balances, banktypes.Balance{Address: RandomAddress, Coins: balances})
	genesisState.BankGenesis.Balances = append(genesisState.BankGenesis.Balances, banktypes.Balance{Address: ContractAdminAddress, Coins: balances})
	genesisState.BankGenesis.Balances = append(genesisState.BankGenesis.Balances, banktypes.Balance{Address: NoCoinsIssuerAdminAddress, Coins: sdk.NewCoins(sdk.NewCoin(bondDenom, sdk.NewInt(10)))})
	...
	genesisState.AuthGenesis.Accounts = append(genesisState.AuthGenesis.Accounts, accounts...)
