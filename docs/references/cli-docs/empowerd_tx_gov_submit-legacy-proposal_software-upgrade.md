## empowerd tx gov submit-legacy-proposal software-upgrade
...
```
empowerd tx gov submit-legacy-proposal software-upgrade [name] (--upgrade-height [height]) (--upgrade-info [info]) [flags]
```
...
```
  ...
  -b, --broadcast-mode string    Transaction broadcasting mode (sync|async) (default "sync")
      ...
      --daemon-name string       The name of the executable being upgraded (for upgrade-info validation). Default is the DAEMON_NAME env var if set, or else this executable (default "empowerchain-docgen")
