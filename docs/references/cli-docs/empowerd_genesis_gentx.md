...
Example:
```bash
$ empowerd gentx my-key-name 1000000stake --home=/path/to/home/dir --keyring-backend=os --chain-id=test-chain-1 \
```
    --moniker="myvalidator" \
    --commission-max-change-rate=0.01 \
...
```
empowerd genesis gentx [key_name] [amount] [flags]
```
...
```
  ...
  -h, --help                                help for gentx
      ...
      --ip string                           The node's public P2P IP (default "172.30.0.17")
