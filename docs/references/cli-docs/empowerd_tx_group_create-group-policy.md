## empowerd tx group create-group-policy
...
```
empowerd tx group create-group-policy [admin] [group-id] [metadata] [decision-policy-json-file] [flags]
```
...
empowerd tx group create-group-policy [admin] [group-id] [metadata] policy.json
