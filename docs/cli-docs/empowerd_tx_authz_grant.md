...
Examples:
 $ empowerd tx authz grant cosmos1skjw.. send --spend-limit=1000stake --from=cosmos1skl..
 $ empowerd tx authz grant cosmos1skjw.. generic --msg-type=/cosmos.gov.v1.MsgVote --from=cosmos1sk..
