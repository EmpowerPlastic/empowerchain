...
find the proposal-id by running "empowerd query gov proposals".

Example:
```bash
$ empowerd tx gov weighted-vote 1 yes=0.6,no=0.3,abstain=0.05,no_with_veto=0.05 --from mykey
```

```
empowerd tx gov weighted-vote [proposal-id] [weighted-options] [flags]
```
