...
```
empowerd tx ibc client update [client-id] [path/to/client_msg.json] [flags]
```

### Examples

```
empowerd tx ibc client update [client-id] [path/to/client_msg.json] --from node0 --home ../node0/\<app\>cli --chain-id $CID
```
