## empowerd tx wasm submit-proposal update-instantiate-config
...
Example: 
$ empowerd tx gov submit-proposal update-instantiate-config 1:nobody 2:everybody 3:cosmos1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm,cosmos1vx8knpllrj7n963p9ttd80w47kpacrhuts497x

```
empowerd tx wasm submit-proposal update-instantiate-config [code-id:permission] --title [text] --summary [text] --authority [address] [flags]
```
