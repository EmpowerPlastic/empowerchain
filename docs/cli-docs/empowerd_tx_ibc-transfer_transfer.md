## empowerd tx ibc-transfer transfer
...
```
empowerd tx ibc-transfer transfer [src-port] [src-channel] [receiver] [amount] [flags]
```

### Examples

```
empowerd tx ibc-transfer transfer [src-port] [src-channel] [receiver] [amount]
```
