## empowerd tx gov submit-legacy-proposal param-change
...
Example:
```bash
$ empowerd tx gov submit-proposal param-change \<path/to/proposal.json\> --from=\<key_or_address\>
```
...
```
empowerd tx gov submit-legacy-proposal param-change [proposal-file] [flags]
```
