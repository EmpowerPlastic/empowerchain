...
Example:
```bash
$ empowerd tx multisign-batch transactions.json multisigk1k2k3 k1sigs.json k2sigs.json k3sig.json
```
...
```
empowerd tx multisign-batch [file] [name] [[signature-file]...] [flags]
```
