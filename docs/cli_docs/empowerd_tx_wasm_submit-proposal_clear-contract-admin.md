## empowerd tx wasm submit-proposal clear-contract-admin

Submit a clear admin for a contract to prevent further migrations proposal

```
empowerd tx wasm submit-proposal clear-contract-admin [contract_addr_bech32] --title [text] --summary [text] --authority [address] [flags]
```
