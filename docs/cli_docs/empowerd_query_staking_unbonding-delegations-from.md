## empowerd query staking unbonding-delegations-from
...
Example:
```bash
$ empowerd query staking unbonding-delegations-from cosmosvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
```

```
empowerd query staking unbonding-delegations-from [validator-addr] [flags]
```
