## empowerd tx gov submit-legacy-proposal execute-contract

Submit a execute wasm contract proposal (run by any address)

```
empowerd tx gov submit-legacy-proposal execute-contract [contract_addr_bech32] [json_encoded_migration_args] [flags]
```
