## empowerd tx gov submit-legacy-proposal sudo-contract

Submit a sudo wasm contract proposal (to call privileged commands)

```
empowerd tx gov submit-legacy-proposal sudo-contract [contract_addr_bech32] [json_encoded_migration_args] [flags]
```
