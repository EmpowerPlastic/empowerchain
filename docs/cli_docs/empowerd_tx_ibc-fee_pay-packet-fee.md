## empowerd tx ibc-fee pay-packet-fee
...
```
empowerd tx ibc-fee pay-packet-fee [src-port] [src-channel] [sequence] [flags]
```

### Examples

```
empowerd tx ibc-fee pay-packet-fee transfer channel-0 1 --recv-fee 10stake --ack-fee 10stake --timeout-fee 10stake
```
