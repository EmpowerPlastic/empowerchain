## empowerd tx plasticcredit update-applicant
...
```
empowerd tx plasticcredit update-applicant [admin_key_or_address] [applicant ID] [name] [description] [flags]
```
...
```
  ...
  -h, --help                     help for update-applicant
