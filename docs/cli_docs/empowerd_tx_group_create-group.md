## empowerd tx group create-group
...
```
empowerd tx group create-group [admin] [metadata] [members-json-file] [flags]
```
...
empowerd tx group create-group [admin] [metadata] [members-json-file]
