## empowerd tx group update-group-members

Update a group's members. Set a member's weight to "0" to delete it.

```
empowerd tx group update-group-members [admin] [group-id] [members-json-file] [flags]
```
...
empowerd tx group update-group-members [admin] [group-id] [members-json-file]
