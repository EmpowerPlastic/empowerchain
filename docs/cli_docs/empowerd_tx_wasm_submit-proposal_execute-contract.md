## empowerd tx wasm submit-proposal execute-contract

Submit a execute wasm contract proposal (run by any address)

```
empowerd tx wasm submit-proposal execute-contract [contract_addr_bech32] [json_encoded_migration_args] --title [text] --summary [text] --authority [address] [flags]
```
