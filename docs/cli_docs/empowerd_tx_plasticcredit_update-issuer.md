## empowerd tx plasticcredit update-issuer
...
```
empowerd tx plasticcredit update-issuer [admin_key_or_address] [issuer-id] [name] [description]  [flags]
```
