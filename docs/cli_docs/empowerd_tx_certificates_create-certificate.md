## empowerd tx certificates create-certificate

create a new certificate

```
empowerd tx certificates create-certificate [certificate file path] [flags]
```

### Examples

```
empowerd tx certificates create-certificate  ./create_certificate.json
...
```
  ...
  -h, --help                     help for create-certificate
