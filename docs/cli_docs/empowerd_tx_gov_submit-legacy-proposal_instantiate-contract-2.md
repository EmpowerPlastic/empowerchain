## empowerd tx gov submit-legacy-proposal instantiate-contract-2

Submit an instantiate wasm contract proposal with predictable address

```
empowerd tx gov submit-legacy-proposal instantiate-contract-2 [code_id_int64] [json_encoded_init_args] [salt] --label [text] --title [text] --description [text] --run-as [address] --admin [address,optional] --amount [coins,optional] --fix-msg [bool,optional] [flags]
```
