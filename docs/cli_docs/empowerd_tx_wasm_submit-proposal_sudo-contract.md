## empowerd tx wasm submit-proposal sudo-contract

Submit a sudo wasm contract proposal (to call privileged commands)

```
empowerd tx wasm submit-proposal sudo-contract [contract_addr_bech32] [json_encoded_migration_args] --title [text] --summary [text] --authority [address] [flags]
```
