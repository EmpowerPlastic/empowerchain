...
import { isSet, toTimestamp, fromTimestamp, fromJsonTimestamp, Long } from "../../../helpers";
...
export const Validator = {
  encode(message: Validator, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.unbondingHeight !== BigInt(0)) {
      writer.uint32(64).int64(Long.fromString(message.unbondingHeight.toString()));
    }
    ...
    if (message.unbondingOnHoldRefCount !== BigInt(0)) {
      writer.uint32(96).int64(Long.fromString(message.unbondingOnHoldRefCount.toString()));
    }
...
export const UnbondingDelegationEntry = {
  encode(message: UnbondingDelegationEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creationHeight !== BigInt(0)) {
      writer.uint32(8).int64(Long.fromString(message.creationHeight.toString()));
    }
    ...
    if (message.unbondingId !== BigInt(0)) {
      writer.uint32(40).uint64(Long.fromString(message.unbondingId.toString()));
    }
    if (message.unbondingOnHoldRefCount !== BigInt(0)) {
      writer.uint32(48).int64(Long.fromString(message.unbondingOnHoldRefCount.toString()));
    }
    return writer;
  },
