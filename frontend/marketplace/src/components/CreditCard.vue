    ...
    <div class="hidden md:grid  md:col-span-2">
      <div class="grid-cols-4 grid gap-3 p-5">
        ...
        <div class="col-span-1">
          ...
          <p class="text-title18 font-bold">PP, PET</p>
        </div>
        <div class="col-span-2 flex flex-col justify-between text-right">
          <p class="text-title32 font-bold">100.00 ABCD</p>
          <div class="grid grid-cols-2 gap-3">
            <button
                class="btn rounded-sm text-greenPrimary font-bold text-title14 bg-buttonBlack normal-case border-none">
              View certificate
            </button>
            <button
                class="btn rounded-sm text-greenPrimary font-bold text-title14 bg-buttonBlack normal-case border-none">
