  ...
  <div class="grid grid-cols-6 gap-5 max-h-[500px] my-5 w-full">
    <div class="col-span-4 w-full">
      ...
      <div v-else="!showSpinner">
        <CustomImage :src="activeImageURL" image-class="rounded-sm h-[500px]" />
      </div>
    </div>
    <div class="max-h-[500px] px-3 col-span-2 overflow-auto">
      ...
      <div class="grid grid-cols-2 gap-5">
        <div
          v-if="showSpinner"
          class="rounded-sm h-[150px] w-full cursor-pointer"
        >
          <CustomSpinner :visible="showSpinner" />
        </div>
        <div v-if="showSpinner === false">
          <CustomImage
            ...
            :src="url"
            image-class="rounded-sm h-[100px] w-[150px] w-full cursor-pointer"
