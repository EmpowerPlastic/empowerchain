    ...
    <div class="grid grid-rows-3 gap-6 mb-14 text-center md:text-left md:gap-1">
      ...
      <div>
        <p class="text-textLightGray text-title14">
          Decentralizing the new (circular) economy so everyone can get a fair share of the upside of making the world a
          cleaner and better place.
        </p>
      </div>
      <div>
        <a class="text-textLightGray underline" href="mailto:hi@empowerchain.io">
          hi@empowerchain.io
        </a>
      </div>
    </div>
