...
<!--  Desktop UI-->
  <div class="hidden md:flex bg-darkGray p-3 rounded-sm my-9">
    <input type="text" class="w-full rounded-sm p-3 active:border-none  bg-darkGray" placeholder="Search credits"/>
  ...
  <div class="md:hidden input-group bg-white text-black rounded-lg my-5">
    ...
    <input type="text" class="w-full p-2 !rounded-lg active:border-none" placeholder="Search credits"/>
  </div>
</template>