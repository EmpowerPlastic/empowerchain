...
export class LCDQueryClient {
  ...
  async creditTypes(params: QueryCreditTypesRequest = {
    ...
    const endpoint = `empowerchain/empowerchain/plasticcredit/credit-types`;
  ...
  async creditType(params: QueryCreditTypeRequest): Promise<QueryCreditTypeResponseSDKType> {
    const endpoint = `empowerchain/empowerchain/plasticcredit/credit-types/${params.creditTypeAbbreviation}`;
