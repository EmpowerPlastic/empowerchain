      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("../cosmos/auth/v1beta1/tx.rpc.msg"));
          });
        case 3:
        ...
        case 15:
          ...
          _context.next = 21;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("../cosmos/consensus/v1/tx.rpc.msg"));
          });
        case 21:
        ...
        case 62:
          ...
          _context.next = 68;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("../cosmos/mint/v1beta1/tx.rpc.msg"));
          });
        case 68:
        ...
        case 98:
          ...
          _context.next = 105;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("./plasticcredit/tx.rpc.msg"));
          });
        case 105:
          _context.t68 = _context.sent.MsgClientImpl;
          _context.t69 = rpc;
          _context.t70 = new _context.t68(_context.t69);
          _context.next = 110;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("./proofofexistence/tx.rpc.msg"));
          });
        case 110:
          _context.t71 = _context.sent.MsgClientImpl;
          _context.t72 = rpc;
          _context.t73 = new _context.t71(_context.t72);
          _context.t74 = {
            plasticcredit: _context.t70,
            proofofexistence: _context.t73
          };
          return _context.abrupt("return", {
            cosmos: _context.t67,
            empowerchain: _context.t74
          });
        case 115:
        case "end":
