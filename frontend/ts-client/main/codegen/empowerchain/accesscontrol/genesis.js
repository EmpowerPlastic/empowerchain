...
exports.ModulePermStore = exports.GenesisState = exports.Access = void 0;
...
var GenesisState = {
  encode: function encode(message) {
    ...
    var _iterator = _createForOfIteratorHelper(message.permStores),
      _step;
    try {
  ...
  fromPartial: function fromPartial(object) {
    ...
    var message = createBaseGenesisState();
    message.permStores = ((_object$permStores = object.permStores) === null || _object$permStores === void 0 ? void 0 : _object$permStores.map(function (e) {
      return ModulePermStore.fromPartial(e);
    })) || [];
    return message;
  }
};
...
var ModulePermStore = {
  encode: function encode(message) {
    ...
    var _iterator2 = _createForOfIteratorHelper(message.accesses),
      _step2;
    try {
  ...
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseModulePermStore();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.accesses = ((_object$accesses = object.accesses) === null || _object$accesses === void 0 ? void 0 : _object$accesses.map(function (e) {
      return Access.fromPartial(e);
    })) || [];
    return message;
  }
};
exports.ModulePermStore = ModulePermStore;
