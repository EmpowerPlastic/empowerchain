    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 15:
          ...
          _context.next = 19;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("../cosmos/autocli/v1/query.rpc.Query"));
          });
        case 19:
        ...
        case 23:
          ...
          _context.next = 27;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("../cosmos/base/node/v1beta1/query.rpc.Service"));
          });
        case 27:
        ...
        case 31:
          ...
          _context.next = 36;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("../cosmos/consensus/v1/query.rpc.Query"));
          });
        case 36:
        ...
        case 67:
          ...
          _context.next = 71;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("../cosmos/orm/query/v1alpha1/query.rpc.Query"));
          });
        case 71:
        ...
        case 92:
          ...
          _context.next = 97;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("./plasticcredit/query.rpc.Query"));
          });
        case 97:
          _context.t46 = _context.sent.createRpcQueryExtension(client);
          _context.next = 100;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("./proofofexistence/query.rpc.Query"));
          });
        case 100:
          _context.t47 = _context.sent.createRpcQueryExtension(client);
          _context.t48 = {
            plasticcredit: _context.t46,
            proofofexistence: _context.t47
          };
          return _context.abrupt("return", {
            cosmos: _context.t45,
            empowerchain: _context.t48
          });
        case 103:
        case "end":
