...
exports.Proof = exports.GenesisState = void 0;
...
var GenesisState = {
  encode: function encode(message) {
    ...
    var _iterator = _createForOfIteratorHelper(message.proofList),
      _step;
    try {
  ...
  fromPartial: function fromPartial(object) {
    ...
    var message = createBaseGenesisState();
    message.proofList = ((_object$proofList = object.proofList) === null || _object$proofList === void 0 ? void 0 : _object$proofList.map(function (e) {
      return Proof.fromPartial(e);
    })) || [];
    return message;
  }
};
...
var Proof = {
  encode: function encode(message) {
    ...
    if (message.metadata !== undefined) {
      _types.ProofMetadata.encode(message.metadata, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  decode: function decode(input, length) {
